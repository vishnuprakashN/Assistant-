...
def openai_gpt3(recognized_text):
    ...
    openai.api_key = "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"
    ...
    while True:
        ...
        response = openai.Completion.create(
          ...
          prompt="The following is a conversation with an AI humanoid robot assistant named rocky. The robot is helpful, creative, clever, and very friendly.\n\nHuman: Hello, who are you?\nAI: My name is rocky\nHuman: who created you?\nAI:Iam was created by vishnu prakash\nHuman: "+ text_input,
          temperature=0.9,
          max_tokens=150,
          top_p=1,
          frequency_penalty=0,
...
def speak(text):
    ...
    t4.start()
    os.system("mpg321 audio.mp3" +" tempo 3.9")
